...
//        GlStateManager.blendFunc(GlStateManager.SourceFactor.ONE, GlStateManager.DestFactor.ZERO);
    ...
    public static void drawBoxBottom(BlockPos hole, int red, int green, int blue, Integer value) {
    }

    public static void drawBoundingBoxBottomBlockPos(BlockPos hole, float floatValue, int red, int green, int blue, Integer value) {
    }
}
