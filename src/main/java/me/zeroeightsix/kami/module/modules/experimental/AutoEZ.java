 ...
 */
@Module.Info(name = "AutoEZ", category = Module.Category.CHAT, description = "Yeah. FUCK YOU KID")
public class AutoEZ extends Module {
    ...
    public enum Mode {
		GG("GG, $NAME"),
		ONTOP("^ EZ'd by Obama himself"),
		EZD("Go cry, $NAME"),
		EZ_HYPIXEL("EZ Win $NAME"),
		NAENAE("you just got shat on with ObamaHack, $NAME"),
		CUSTOM();
