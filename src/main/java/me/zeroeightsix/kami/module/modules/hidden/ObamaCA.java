...
@Module.Info(name = "Obama CA", description = "Crystal Aura", category = Module.Category.HIDDEN)
...
//re
    ...
    public void onEnable() {
        ...
        if (this.chatAlert.getValue()) {
            Command.sendChatMessage("\u00A7aObama AutoCrystal ON");
        }
    ...
    public void onDisable() {
        ...
        if (chatAlert.getValue()) {
            Command.sendChatMessage("\u00A7aObama AutoCrystal" + ChatFormatting.RED.toString() + " OFF");
        }
