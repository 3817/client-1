 ...
 */
@Module.Info(name = "ZEOCrystalAura", category = Module.Category.COMBAT)
public class ZEOCrystalAura extends Module {
    ...
    private Setting<Double>  range = register(Settings.d("Range", 3));
    ...
    public void onUpdate() {
        ...
        if (explode.getValue() && crystal != null && mc.player.getDistance(crystal) <= range.getValue()) {
            ...
            if (((System.nanoTime() / 10000) - systemTime) >= 0.01) {
